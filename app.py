...
st.markdown(
    ...
    ">
        <div style="text-align: justify; font-size: 15px;">
            <span style="color: #BC13FE; font-weight: 800;">
            TCO Comparison by Year</span>
...
# Dataframe
columns = ["Scope", "Desc", "Y0", "Y1", "Y2", "Y3", "Y4", "Y5", "TOTAL 5Y"]
...
data = [
    ["Software", 61800, 58100, 60800, 58100, "Vendor B", 60800, "Vendor C", 4.7, 60800, 1.6, -4.4, 0],
